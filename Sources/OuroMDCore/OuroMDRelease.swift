...
public enum OuroMDRelease {
    ...
    public static let version = "0.9.45"
    public static let userAgent = "OuroMD/\(version)"
    public static let releaseDate = "2026-06-25"
    public static let releaseHighlights = [
        "Keeps Ouro MD on the current shared native shell by refreshing the app-shell dependency and adding a CI/preflight guard that rejects stale branch pins.",
    ]
}
