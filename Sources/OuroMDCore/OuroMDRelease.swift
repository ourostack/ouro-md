...
public enum OuroMDRelease {
    ...
    public static let version = "0.9.85"
    public static let userAgent = "OuroMD/\(version)"
    public static let releaseDate = "2026-08-24"
    ...
    public static let releaseHighlights = [
        ...
        "Render reference-style links cleanly and follow heading links within or across local documents.",
    ]
}
