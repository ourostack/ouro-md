...
public enum CommandPaletteCatalog {
    public static func items(themes: [CommandPaletteTheme]) -> [CommandPaletteItem] {
        var items: [CommandPaletteItem] = [
            ...
            CommandPaletteItem(id: "file.reveal-in-finder", title: "Reveal in Finder", keywords: "finder reveal locate file path"),
            CommandPaletteItem(id: "file.copy-path", title: "Copy File Path", keywords: "copy clipboard absolute path"),
            CommandPaletteItem(id: "file.copy-relative-path", title: "Copy Relative Path", keywords: "copy clipboard relative path repository git"),
            CommandPaletteItem(id: "file.copy-git-diff-command", title: "Copy Git Diff Command", keywords: "copy clipboard git diff command feedback"),
