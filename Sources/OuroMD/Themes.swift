...
private func editorCSS(_ p: Palette) -> String {
    ...
    .vditor-ir .vditor-ir__node[data-type="link-ref"],.vditor-ir .vditor-ir__node[data-type="link-ref"] .vditor-ir__link{color:\(p.accent)!important;text-decoration:underline;}
