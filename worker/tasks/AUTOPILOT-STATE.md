...
- PR head: pending CI-fix commit after `eef985c957344546cf3929618440c7382c056e2a`
...
- Next action: commit/push the Unit 8c CI fix, wait for PR #103 CI, post pre-merge sanity-check comment, merge to main, then run terminal cleanup and continuation scan.
