...
- Branch: `worker/ouro-md-command-catalog-extraction`
...
| --- | --- | --- | --- |
| execute command catalog extraction | ready | roadmap R4 and doing doc are approved under reviewer gate | in progress |
