...
final class ReleaseUpdateTests: XCTestCase {
    ...
    func testReleaseDescriptorMatchesCurrentDistribution() {
        ...
        XCTAssertEqual(OuroMDRelease.version, "0.9.3")
        XCTAssertEqual(OuroMDRelease.userAgent, "OuroMD/0.9.3")
    }
    ...
    func testDefaultConfigurationTargetsOuroMDGitHubReleases() {
        ...
        XCTAssertEqual(configuration.currentVersion, "0.9.3")
        XCTAssertEqual(
    ...
    func testDefaultLoaderSendsExpectedGitHubRequestAndReturnsBody() async throws {
        ...
        XCTAssertEqual(request.value(forHTTPHeaderField: "User-Agent"), "OuroMD/0.9.3")
    }
